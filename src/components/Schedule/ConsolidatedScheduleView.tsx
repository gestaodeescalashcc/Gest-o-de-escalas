        ...
        {loading ? (
          ...
          <>
            ...
            <div className="overflow-x-auto -mx-6 px-6">
              ...
              {/* Profissionais afastados (recebendo salário) — fora da grade */}
